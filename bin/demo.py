...
from siamlight.tracker.tracker_builder import build_tracker
from siamlight.utils.model_load import load_pretrain
...
parser.add_argument('--snapshot', default='./snapshot/checkpoint_e20.pth', type=str, help='model name')
